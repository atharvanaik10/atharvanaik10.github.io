...
### Latent Traits and Cross-Task Transfer
Role: Researcher · *SEM 2025
Location: University of Illinois Urbana-Champaign
Period: 2025
Order: 2
Skills: Large Language Models, Transfer Learning, Representation Analysis, NLP
Links: [Paper](https://arxiv.org/abs/2509.13624)
...
### Limitations of Embedding-Based Metrics for Code Generation
Role: Independent Researcher
Location: University of Illinois Urbana-Champaign
Period: 2024
Order: 4
Skills: Code Generation, Evaluation, Large Language Models, Software Engineering
Links: [arXiv Preprint](https://arxiv.org/abs/2405.01580)

- Evaluated embedding-based metrics as measures of functional correctness across outputs from ten models and two code-generation benchmarks. Found weak correlation with functional correctness, but substantially stronger correlation with the human effort required to edit generated code.
...
- Studied uniform distribution and rigidity in fractional-part sequences, with particular attention to powers of rational numbers. Developed computational methods to measure deviation from uniformity and used them to investigate conjectured distributional behavior.
