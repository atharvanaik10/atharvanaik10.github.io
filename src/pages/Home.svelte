...
<section id="about" class="hero-section">
  <div class="hero-copy">
    ...
    <p class="hero-intro type-body">I’m a Trading Operations Engineer at
      ...
      <br><br>
      My research focuses on game-theoretic and optimization methods for public-sector resource allocation, particularly under strategic behavior, uncertainty, and operational constraints. I currently work with Professor <a href="https://rutamehta.cs.illinois.edu/" target="_blank">Ruta Mehta</a> on security-game formulations of police patrol allocation. <a href="https://arxiv.org/abs/2603.29288" target="_blank">My M.S. thesis</a>, completed in the <a href="https://oncare.cs.illinois.edu" target="_blank">OnCare Lab</a> with Professor <a href="https://koustuv.com/" target="_blank">Koustuv Saha</a>, examined caste bias in LLM-driven matchmaking and evaluated a guardrail-based intervention designed to interrupt biased reasoning.
      <br><br>
    ...
    <div class="hero-actions">
      ...
      <Button variant="filled" size="m" href="https://www.linkedin.com/in/atharvanaik10" target="_blank" rel="noreferrer" iconType="left">
        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.4 20.5h-3.6v-5.6c0-1.3 0-3.1-1.9-3.1s-2.2 1.5-2.2 3v5.7H9.1V9h3.5v1.6h.1c.5-.9 1.7-1.9 3.5-1.9 3.8 0 4.4 2.5 4.4 5.7v6.1ZM5.1 7.4a2.1 2.1 0 1 1 0-4.2 2.1 2.1 0 0 1 0 4.2ZM6.9 20.5H3.3V9h3.6v11.5Z" /></svg>
        LinkedIn
      </Button>
      <Button variant="outlined" size="m" href="mailto:atharvanaik10@gmail.com" iconType="left">
