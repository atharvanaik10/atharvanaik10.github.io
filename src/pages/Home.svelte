...
<section
  ...
  <div class="relative z-10 grid items-center gap-6 hero-text">
    <div>
      ...
      <p class="mt-6 max-w-3xl text-base text-white/80">I’m a second year M.S. student studying 
        ...
        Before that, I was a Machine Learning Intern at <a href="https://www.ameren.com/about-ameren"  target="_blank" class="text-primary hover:underline">Ameren</a>, where I worked on time-series forecasting and deep-learning for survival analysis.
        <br><br>
